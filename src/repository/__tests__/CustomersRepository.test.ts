...
describe('CustomersRepositoryImpl', () => {
  describe('findByFilter', () => {
    ...
    it('should return a customer including the searched name', async () => {
      // Prepare
      const repository = new CustomersRepositoryImpl();
      ...
      const customer = await repository.findByFilter(
        new Customer({
          name: 'ad',
        })
      );
    ...
    it('should return a customer including the searched lastName', async () => {
      // Prepare
      const repository = new CustomersRepositoryImpl();
